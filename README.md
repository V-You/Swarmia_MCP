...
| :---: | :----: | :---: |
| <kbd><img src="img/Screenshot_2026-02-23_023512.png" alt="Scenario 2: I just joined the team" width="99px" /></kbd> | <kbd><img src="img/Screenshot_2026-02-28_212820.png" alt="Scenario 2: Check last few commits - Rich" width="99px" /></kbd> | <kbd><img src="img/Screenshot_2026-02-28_210351.png" alt="Scenario 2: Check last 5 commits" width="99px" /></kbd> |
...
```
> <img src="img/Screenshot_2026-02-23_205953.png" width="22">&nbsp;Agent queries bundled documentation and returns a concise answer (max 3 sentences) grounded in official Swarmia help center content.
...
- With `LINEAR_API_KEY`: Full validation &ndash; issue title, status, assignment
...
- Pure generation &ndash; returns YAML/config as text, does not write to the filesystem
