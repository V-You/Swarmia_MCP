...
| **2** | CSS injection via `ctx.styles.css.fonts` into `<style>` element | Sanitize or allowlist CSS properties from host context | SJIP FOR NOW: "safe CSS" research needed, host VS Code = low risk |
